    ...
    <div className='w-full px-24 pt-24 bg-[#f5f6f7]  '>
      ...
      <div className=''>
        ...
        <div className='space-y-2  text-gray-700 font-normal'>
            <p className='text-xl font-semibold text-[#164343] mb-5 '>Quick Link</p>
        ...
        <div className='space-y-2  text-gray-700 font-normal'>
            <p className='text-xl font-semibold text-[#164343] mb-5 space-y-2.5'>Services</p>
        ...
        <div className='space-y-2 text-gray-700 font-normal'>
            <p className='text-xl font-semibold text-[#164343] mb-5 space-y-2.5'>Information</p>
      ...
      <div className='py-5 text-center  text-gray-700 font-normal'>
