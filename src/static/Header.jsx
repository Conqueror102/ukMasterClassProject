    ...
    <div className=" bg-white sticky top-0 shadow-lg w-full text-sm  py-4 max-sm:p-2 z-50">
      <Padding>
        ...
        <div className="flex justify-between items-center ">
          ...
          {/* nav */}
          <nav className="flex  items-center w-74 gap-10 max-sm:hidden">
          ...
          <div className="flex items-center">
            ...
            <div className="text-lg cursor-pointer bg-[#2b4dff] text-[#16a571] p-2 font-semibold rounded-sm hidden max-sm:flex">
              <RxHamburgerMenu />
            </div>
          </div>
        </div>
